...
<head>
  ...
  <script src="https://cdn.tailwindcss.com"></script>
    ...
    <title>Product Creation - THE PEEPS</title>
</head>
      ...
      <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <!-- Menu ID (readonly) -->
            <div>
              <label for="menuID" class="block text-sm font-medium text-gray-700 mb-1">Menu ID <b style="color: red">*</b></label>
            ...
            <!-- Menu Name -->
            <div>
              <label for="menuName" class="block text-sm font-medium text-gray-700 mb-1">Menu Name <b style="color: red">*</b></label>
            ...
            <!-- Menu Price -->
            <div>
              <label for="menuPrice" class="block text-sm font-medium text-gray-700 mb-1">Price <b style="color: red">*</b></label>
             ...
             <!-- Menu Calorie -->
            <div>
              <label for="menuCalorie" class="block text-sm font-medium text-gray-700 mb-1">Calories <b style="color: red">*</b></label>
            ...
            <!-- Menu Category -->
            <div>
              <label for="menuType" class="block text-sm font-medium text-gray-700 mb-1">Category <b style="color: red">*</b></label>
